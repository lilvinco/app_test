...
/// A widget that will display a BoxScrollView with
/// a ScrollThumb that can be dragged
...
class CustomDraggableScrollbar extends StatefulWidget {
  ...
  /// Determines scrollThumb displaying.
  /// If you draw own ScrollThumb and it is true you just don't need to use
  ///  animation parameters in [scrollThumbBuilder]
  ...
  CustomDraggableScrollbar.rrect({
    Key? key,
    Key? scrollThumbKey,
    this.alwaysVisibleScrollThumb = false,
    required this.child,
  ...
  static ScrollThumbBuilder _thumbSemicircleBuilder(
    ...
    return (
      ...
      final CustomPaint scrollThumb = CustomPaint(
        key: scrollThumbKey,
        foregroundPainter: ArrowCustomPainter(IGrooveTheme.colors.grey),
        child: Material(
          elevation: 4.0,
          child: Container(
